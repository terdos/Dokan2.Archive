namespace SevenZip
{
    ...
    public static class Formats
    {
        ...
        public static InArchiveFormat FormatByFileName(string fileName, bool reportErrors)
        {
            ...
            extension = extension.Length > 1 ? extension.Substring(1) : "";

            if (!InExtensionFormats.ContainsKey(extension) && reportErrors)
            {
                throw new SevenZipArchiveException("Extension \"" + extension + "\" is not a supported archive file name extension.");
